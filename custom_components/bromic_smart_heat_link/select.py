...
async def async_setup_entry(
    ...
    """Set up Bromic select entities from a config entry."""
...
class BromicPowerLevelSelect(BromicEntity, SelectEntity):
    ...
    def __init__(
        ...
        """
        super().__init__(hub, id_location, 0, controller_type, "select")
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        _LOGGER.debug(
            ...
            self.entity_id, self._id_location, option, button_code
        )
